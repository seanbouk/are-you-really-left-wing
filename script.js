...
const scales = [
    ...
    },
    {
        ...
        labelLeft: "Large Government",
        labelRight: "Small Government",
        questions: [
            {
    ...
    },
    {
        ...
        labelLeft: "Democratic",
        labelRight: "Authoritarian",
        questions: [
            {
    ...
    },
    {
        ...
        labelLeft: "Internationalist",
        labelRight: "Nationalist",
        questions: [
            {
    ...
    },
    {
        ...
        labelLeft: "Freedom From",
        labelRight: "Freedom To",
        questions: [
            {
    ...
    },
    {
        ...
        labelLeft: "Collectivism",
        labelRight: "Individual Freedom",
        questions: [
            {
    ...
    },
    {
        ...
        labelLeft: "Regulation",
        labelRight: "Libertarian",
        questions: [
            {
    ...
    },
    {
        ...
        labelLeft: "Distribution",
        labelRight: "Property Rights",
        questions: [
            {
...
function getDescription(scaleId, avg) {
    ...
    const labels = {
        "royalist-parliamentarian": ["parliamentarian", "royalist"],
        "capitalist-socialist": ["socialist", "capitalist"],
        "small-large-government": ["large government", "small government"],
        "traditionalism-progressivism": ["progressive", "traditionalist"],
        "hierarchy-equality": ["equality", "hierarchy"],
        "authoritarianism-democracy": ["democratic", "authoritarian"],
        "nationalism-internationalism": ["internationalist", "nationalist"],
        "freedom-to-freedom-from": ["'freedom from'", "'freedom to'"],
        "preservation-reform": ["reform", "preservation"],
        "individual-collectivism": ["collectivist", "individual freedom"],
        "libertarianism-regulation": ["regulation", "libertarian"],
        "property-distribution": ["distribution", "property rights"]
    };
